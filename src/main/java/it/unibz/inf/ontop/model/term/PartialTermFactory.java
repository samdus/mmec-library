 ...
 * @version 1.2.0
 *
 * @brief @~french Implémentation de la classe PartialTermFactory.
 * @brief @~english PartialTermFactory class implementation.
 */
 ...
 *
 * @brief @~french Indirection de la classe TermFactoryImpl dont le constructeur est privé.
 * @par Détails'
 *      Comme le constructeur est privé, il était impossible d'hériter de la classe comme il faut
 * @par Modèle
 *      S.O.
 * @par Conception
 *      S.O.
 ...
 *
 * @par Historique
 *      2024-08-27 [SD] - Implémentation initiale<br>
 *
 * @par Tâches
 *      S.O.
 */
public abstract class PartialTermFactory implements TermFactory {
  protected final TermFactory defaultTermFactory;

  @Inject
  public PartialTermFactory(TermFactoryImpl defaultTermFactory) {
