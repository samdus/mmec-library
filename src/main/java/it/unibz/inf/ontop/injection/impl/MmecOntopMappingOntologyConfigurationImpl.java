...
public class MmecOntopMappingOntologyConfigurationImpl extends OntopMappingConfigurationImpl
    ...
    protected MmecOntopMappingOntologyConfigurationImpl(OntopMappingSettings settings, OntopMappingOntologyOptions options) {
    ...
    protected MmecOntopMappingOntologyConfigurationImpl(OntopMappingSettings settings, OntopMappingOntologyOptions options, Supplier<Injector> injectorSupplier) {
