...
public class MMecR2RMLToSQLPPTriplesMapConverter {

	private static final Logger LOGGER = LoggerFactory.getLogger(MMecR2RMLToSQLPPTriplesMapConverter.class);
	...
	@Inject
	private MMecR2RMLToSQLPPTriplesMapConverter(TermFactory termFactory,
