 ...
 *
 * @brief @~french Implémentation de la classe SubsetHasTemplateException.
 * @brief @~english SubsetHasTemplateException class implementation.
 */
 ...
 *      S.O.
 */
public class SubsetHasTemplateException extends IllegalMappingException {
