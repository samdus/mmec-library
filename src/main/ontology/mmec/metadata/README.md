 ...
 * [mmec.yml](mmec.yml)
     * Determines how your purl.obolibrary.org/obo/mmec/ redirects will be handled
     ...
     * Paste in the contents of [mmec.yml](mmec.yml)
 ...
 * [mmec.md](mmec.md)
     ...
     * Paste in the contents of [mmec.md](mmec.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
