...
\MACHINE{4-AnimationMachine}{3-ExpressionAnalysis}{\_\_\_\_950-AnimationContext\_SignMult}{}
\VARIABLES{
...
\EVT{next\_class}{true}{ordinary}{next\_class}{}{
	...
	\ACTIONS{true}{
		...
		\Action{nextClass\_resetCurrentExpressionAnalysed}{$currentExpressionAnalysed \bcmeq{} 0$}{false}{}
	}
}
\EVT{next\_level}{true}{ordinary}{next\_level}{}{
	\GUARDS{false}{
		...
		\Guard{nextLevel\_grd3}{false}{$levelNum > 0$}{false}{\\on peut encore descendre d'un niveau}
	}
	\ACTIONS{true}{
...
\EVT{class\_mapped}{true}{ordinary}{class\_mapped}{\\l'arrimage de la classe est terminé}{
	\GUARDS{false}{
		...
		\Guard{classMapped\_grd2}{false}{$expressionsOfCurrentClass \subseteq{} analysedExpressions\converse{}[\{currentClass\}]$}{false}{\\toutes les expressions de la classe courante sont analysées}
	}
	\ACTIONS{true}{
...
\EVT{expression\_analysed}{true}{ordinary}{expression\_analysed}{}{
	\GUARDS{false}{
		...
		\Guard{expressionAnalysed\_grd4}{false}{$currentExpressionAnalysed = 1$}{false}{\\l'analyse de l'expression courante est terminée}
	}
	\ACTIONS{true}{
...
\EVT{analyse\_current\_subsets\_signature}{true}{ordinary}{analyse\_current\_subsets\_signature}{}{
	\GUARDS{false}{
		...
		\Guard{analyseCurrentSubsetsSignature\_grd4}{false}{$\\\lnot{} (\exists{}s,c \qdot{} s \in{} exp\_equivalent[\{currentExpression\}] \land{}\\~         c \neq{} currentClass \land{}\\~         s \mapsto{} c \in{} definedSignatures)$}{false}{\\il n'existe pas de signature correspondant à une expression équivalente}
		\Guard{analyseCurrentSubsetsSignature\_grd5}{false}{$\\\lnot{} (\exists{}e \qdot{} e \in{} dom(definedSignatures) \land{}\\~       e \in{} exp\_overlap[\{currentExpression\}] \land{}\\~       exp\_key(currentExpression) \notin{} key\_compatible[\{exp\_key(e)\}])$}{false}{\\il n'existe pas de signature qui overlap et dont la clé n'est pas compatible}
	}
	\ACTIONS{true}{
