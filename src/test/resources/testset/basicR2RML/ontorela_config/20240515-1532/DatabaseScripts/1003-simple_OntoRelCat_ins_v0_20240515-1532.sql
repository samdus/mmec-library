...
*/
 ...
 call "ontorelcat_pub".onto_data_type_ins ('basicR2RML','http://www.w3.org/1999/02/22-rdf-syntax-ns#langString','','TEXT');

 call "ontorelcat_pub".onto_data_type_ins ('basicR2RML','http://www.w3.org/2001/XMLSchema#string','','TEXT');
