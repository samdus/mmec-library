...
COMMENT ON SCHEMA "simple" IS 'Schéma simple créé le 20240515-1532';
...
COMMENT ON CONSTRAINT "fk0_T4f2a1f0000" ON "simple"."T4f2a1f0000" IS 'tst2 -> tst1 C0004Xtst3 | rel | tst2 unionOf tst2 | tst3';
...
COMMENT ON CONSTRAINT "fk0_T4f2a1f1000" ON "simple"."T4f2a1f1000" IS 'tst3 -> tst';
...
COMMENT ON CONSTRAINT "fk1_T4f2a1f0000" ON "simple"."T4f2a1f0000" IS 'tst2 -> tst';
...
COMMENT ON CONSTRAINT "fk1_T4f2a1f1000" ON "simple"."T4f2a1f1000" IS 'tst3 -> tst1 C0004Xtst3 | rel | tst2 unionOf tst2 | tst3';
