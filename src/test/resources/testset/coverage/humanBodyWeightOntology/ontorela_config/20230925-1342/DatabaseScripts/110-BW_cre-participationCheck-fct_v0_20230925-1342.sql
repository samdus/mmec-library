...
-- Maximum participqtion ckeck on : T002c
CREATE OR REPLACE FUNCTION "BW".T002c_checkParticipationMax(_T0006_uid "BW"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  ...
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect maximal value %', 'T002c', 1;
    RETURN FALSE;
  END IF;
END;
$$
