...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20230925-1342';
...
COMMENT ON VIEW "BW_en"."T0007_process" IS 'p is a process = Def. p is an occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t. (axiom label in BFO2 Reference: [083-003])';
...
COMMENT ON VIEW "BW_en"."T000a_realizable entity" IS 'RealizableEntity';
...
CREATE VIEW "BW_en"."T000e_gdc" AS
  SELECT "T000e_uid" AS "uid gdc"
  FROM "BW"."T000e";

COMMENT ON VIEW "BW_en"."T000e_gdc" IS 'b is a generically dependent continuant = Def. b is a continuant that g-depends_on one or more other entities. (axiom label in BFO2 Reference: [074-001])';
...
COMMENT ON VIEW "BW_en"."T0012_occurrent" IS 'Occurrent';
...
COMMENT ON VIEW "BW_en"."T0021_material entity" IS 'An independent continuant that is spatially extended whose identity is independent of that of other entities and can be maintained through time.';

CREATE VIEW "BW_en"."T0022_information content entity" AS
  SELECT "T0022_uid" AS "uid information content entity"
  FROM "BW"."T0022";

COMMENT ON VIEW "BW_en"."T0022_information content entity" IS 'An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity';
...
COMMENT ON VIEW "BW_en"."T002d_process realizes realizable entity" IS 'p is a process = Def. p is an occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t. (axiom label in BFO2 Reference: [083-003]) Paraphrase of elucidation: a relation between a process and a realizable entity, where there is some material entity that is bearer of the realizable entity and participates in the process, and the realizable entity comes to be realized in the course of the process RealizableEntity';
...
COMMENT ON VIEW "BW_en"."T0034_entity part of entity" IS 'Entity 
...
COMMENT ON VIEW "BW_en"."T0036_occurrent has participant continuant" IS 'Occurrent a relation between a process and a continuant, in which the continuant is somehow involved in the process Continuant';
...
COMMENT ON VIEW "BW_en"."T0041_information content entity denotes entity" IS 'An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity null Entity';

CREATE VIEW "BW_en"."T0042_sdc concretizes gdc" AS
  SELECT "T0023_uid" AS "uid sdc",  
    "T000e_uid" AS "uid gdc"
  FROM "BW"."T0042";

COMMENT ON VIEW "BW_en"."T0042_sdc concretizes gdc" IS 'b is a specifically dependent continuant = Def. b is a continuant & there is some independent continuant c which is not a spatial region and which is such that b s-depends_on c at every time t during the course of b’s existence. (axiom label in BFO2 Reference: [050-003]) A relationship between a specifically dependent continuant and a generically dependent continuant, in which the generically dependent continuant depends on some independent continuant in virtue of the fact that the specifically dependent continuant also depends on that same independent continuant. Multiple specifically dependent continuants can concretize the same generically dependent continuant. b is a generically dependent continuant = Def. b is a continuant that g-depends_on one or more other entities. (axiom label in BFO2 Reference: [074-001])';

CREATE VIEW "BW_en"."T0043_IAO_0000032_IAO_0000039_Thing" AS
  SELECT "T0024_uid" AS "uid scalar measurement datum",  
    "T0000_uid" AS "uid Thing"
  FROM "BW"."T0043";

COMMENT ON VIEW "BW_en"."T0043_IAO_0000032_IAO_0000039_Thing" IS 'a scalar measurement datum is a measurement datum that is composed of two parts, numerals and a unit label. null The class owl:Thing is the class of all individuals.';

CREATE VIEW "BW_en"."T0044_IAO_0000032_OBI_0001938_OBI_0001931" AS
  SELECT "T0024_uid" AS "uid scalar measurement datum",  
    "T000d_uid" AS "uid scalar value specification"
  FROM "BW"."T0044";

COMMENT ON VIEW "BW_en"."T0044_IAO_0000032_OBI_0001938_OBI_0001931" IS 'a scalar measurement datum is a measurement datum that is composed of two parts, numerals and a unit label. null A value specification that consists of two parts: a numeral and a unit label';
...
COMMENT ON VIEW "BW_en"."T0045_continuant participates in occurrent" IS 'Continuant a relation between a continuant and a process, in which the continuant is somehow involved in the process Occurrent';
