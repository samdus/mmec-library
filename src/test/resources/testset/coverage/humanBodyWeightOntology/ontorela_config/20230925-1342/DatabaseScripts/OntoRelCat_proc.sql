...
create or replace procedure
  "OntoRelCat".ontorel_ins(in ontorel_id_ character varying, in version_ character varying)
  language sql
as
$$
insert into "OntoRelCat"."Ontorel"(ontorel_id, version)
values (ontorel_id_, version_);
$$;
...
-- Création du procédure onto_import_ins (Insertion dans la table : Ontorel_Import)
create or replace procedure
...
as
$$
insert into "OntoRelCat"."Onto_Class_Inheritance"(ontorel_id, superclass_iri, subclass_iri)
values (ontorel_id_, superclass_iri_, subclass_iri_);
$$;
