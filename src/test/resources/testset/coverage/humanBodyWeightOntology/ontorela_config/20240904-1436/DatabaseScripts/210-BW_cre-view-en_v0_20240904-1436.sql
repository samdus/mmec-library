...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240904-1436';
...
COMMENT ON VIEW "BW_en"."occurrent" IS 'An entity that has temporal parts and that happens, unfolds or develops through time.';
...
COMMENT ON VIEW "BW_en"."ic" IS 'IndependentContinuant';
...
COMMENT ON VIEW "BW_en"."material" IS 'An independent continuant that is spatially extended whose identity is independent of that of other entities and can be maintained through time.';
...
CREATE VIEW "BW_en"."scalar measurement datum has measurement value Decimal" AS
  SELECT "IAO_0000032_IAO_0000004_decimal_IAO_0000004" AS "has measurement value",  
    "IAO_0000032_uid" AS "uid scalar measurement datum"
  FROM "BW"."IAO_0000032_IAO_0000004_decimal";

COMMENT ON VIEW "BW_en"."scalar measurement datum has measurement value Decimal" IS 'IAO_0000032 [1..1] IAO_0000004 decimal';
...
COMMENT ON VIEW "BW_en"."human name has part personal name" IS 'An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. a core relation that holds between a whole and its part Personal names to not include names of fictional characters, e.g. Sherlock Holmes.';
...
COMMENT ON VIEW "BW_en"."occurrent has participant continuant" IS 'An entity that has temporal parts and that happens, unfolds or develops through time. a relation between a process and a continuant, in which the continuant is somehow involved in the process 
An entity that exists in full at any time in which it exists at all, persists through time while maintaining its identity and has no temporal parts.
';
...
COMMENT ON VIEW "BW_en"."ic has role role" IS 'IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role';
