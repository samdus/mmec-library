...
COMMENT ON SCHEMA "BW_ontoView" IS 'Create views with short IRI of BW_ontoView 20240313-1437';
...
COMMENT ON VIEW "BW_ontoView"."HBW_0000022_c" IS 'human name::An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
a core relation that holds between a whole and its part
 Personal names to not include names of fictional characters, e.g. Sherlock Holmes. An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
a core relation that holds between a whole and its part
 An identifier that is typically a part of a person''s name which has been passed, according to law or custom, from one or both parents to their children. An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. null Organism member of the genus Homo, evolving from Homo heidelbergensis or a similar species and migrating out of Africa, gradually replacing or interbreeding with local populations of archaic humans.';
...
COMMENT ON VIEW "BW_ontoView"."BFO_0000004_c" IS 'independent continuant::IndependentContinuant IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role IndependentContinuant a relation between two independent continuants, the target and the location, in which the target is entirely within the location IndependentContinuant';
...
COMMENT ON VIEW "BW_ontoView"."IAO_0020015_p" IS 'personal name::Personal names to not include names of fictional characters, e.g. Sherlock Holmes. DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';
...
COMMENT ON VIEW "BW_ontoView"."IAO_0020015_c" IS 'personal name::Personal names to not include names of fictional characters, e.g. Sherlock Holmes. DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';
...
a core relation that holds between a whole and its part
 A data item that is the specified output of some physiological evaluation. A document that contains information representing the health-relevant qualities of a patient''s body, organ systems, individual organs, cells and biomolecules that perform chemical and physical functions. 
a core relation that holds between a whole and its part
 A CRID symbol that is sufficent to look up a patient file in a medical record registry.';
...
COMMENT ON VIEW "BW_ontoView"."BFO_0000001_c" IS 'entity::per discussion with Barry Smith per discussion with Barry Smith a core relation that holds between a part and its whole per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_ontoView"."IAO_0000030_c" IS 'information content entity::An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity is_about is a (currently) primitive relation that relates an information artifact to an entity. per discussion with Barry Smith An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity null per discussion with Barry Smith';
