...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240313-1437';
...
CREATE VIEW "BW_en"."specifically dependent continuant" AS
  SELECT "BFO_0000020_uid" AS "uid specifically dependent continuant"
  FROM "BW"."BFO_0000020";

COMMENT ON VIEW "BW_en"."specifically dependent continuant" IS 'b is a specifically dependent continuant = Def. b is a continuant & there is some independent continuant c which is not a spatial region and which is such that b s-depends_on c at every time t during the course of b’s existence. (axiom label in BFO2 Reference: [050-003])';

CREATE VIEW "BW_en"."ONTORELA_C4d0c3f45" AS
  SELECT "ONTORELA_C4d0c3f45_uid" AS "ONTORELA_C4d0c3f45_uid"
  FROM "BW"."ONTORELA_C4d0c3f45";

COMMENT ON VIEW "BW_en"."ONTORELA_C4d0c3f45" IS 'medical record identifier intersectionOf A document that contains information representing health-relevant qualities of a patient written in a chronological manner and that is primarily used for patient care in a clinical setting. is_about is a (currently) primitive relation that relates an information artifact to an entity. An organism having the role of patient.';

CREATE VIEW "BW_en"."material" AS
  SELECT "BFO_0000040_uid" AS "uid material"
  FROM "BW"."BFO_0000040";

COMMENT ON VIEW "BW_en"."material" IS 'MaterialEntity';

CREATE VIEW "BW_en"."disposition" AS
  SELECT "BFO_0000016_uid" AS "uid disposition"
  FROM "BW"."BFO_0000016";

COMMENT ON VIEW "BW_en"."disposition" IS 'realizable entity that specifically depends of some material entity,  its bearer, for which is such that if it ceases to exist, then its bearer is physically changed';
...
CREATE VIEW "BW_en"."independent continuant" AS
  SELECT "BFO_0000004_uid" AS "uid independent continuant"
  FROM "BW"."BFO_0000004";

COMMENT ON VIEW "BW_en"."independent continuant" IS 'IndependentContinuant';

CREATE VIEW "BW_en"."personal name" AS
  SELECT "IAO_0020015_uid" AS "uid personal name"
  FROM "BW"."IAO_0020015";

COMMENT ON VIEW "BW_en"."personal name" IS 'Personal names to not include names of fictional characters, e.g. Sherlock Holmes.';
...
COMMENT ON VIEW "BW_en"."female biological sex datum" IS 'A biological sex datum that represents the biological sex of an animal (including human) as being female.';

CREATE VIEW "BW_en"."realizable entity" AS
  SELECT "BFO_0000017_uid" AS "uid realizable entity"
  FROM "BW"."BFO_0000017";

COMMENT ON VIEW "BW_en"."realizable entity" IS 'RealizableEntity';
...
COMMENT ON VIEW "BW_en"."intersex biological sex datum" IS 'A biological sex measurement datum that is intended to denote an intersex biological sex.';
...
CREATE VIEW "BW_en"."birth statement" AS
  SELECT "NOYO_0000050_uid" AS "uid birth statement"
  FROM "BW"."NOYO_0000050";

COMMENT ON VIEW "BW_en"."birth statement" IS 'A statement about the information surrounding the birth of a human.';
...
COMMENT ON VIEW "BW_en"."generically dependent continuant" IS 'b is a generically dependent continuant = Def. b is a continuant that g-depends_on one or more other entities. (axiom label in BFO2 Reference: [074-001])';

CREATE VIEW "BW_en"."ONTORELA_C2986e108-el0" AS
  SELECT "ONTORELA_C2986e108-el0_uid" AS "ONTORELA_C2986e108-el0_uid"
  FROM "BW"."ONTORELA_C2986e108-el0";

COMMENT ON VIEW "BW_en"."ONTORELA_C2986e108-el0" IS 'physiological evaluation intersectionOf data item | is about | inheres in | disposition | quality | organism intersectionOf disposition | quality | inheres in | organism el realizable entity that specifically depends of some material entity,  its bearer, for which is such that if it ceases to exist, then its bearer is physically changed Disposition a specifically dependent continuant that, in contrast to roles and dispositions, does not require any further process in order to be realized Quality';
...
COMMENT ON VIEW "BW_en"."process" IS 'p is a process = Def. p is an occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t. (axiom label in BFO2 Reference: [083-003])';
...
COMMENT ON VIEW "BW_en"."scalar measurement datum has measurement value" IS 'IAO_0000032 [1..1] IAO_0000004 double';

CREATE VIEW "BW_en"."RAMQ vulnerability code has value" AS
...
COMMENT ON VIEW "BW_en"."RAMQ vulnerability code has value" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';

CREATE VIEW "BW_en"."personal name has value" AS
...
COMMENT ON VIEW "BW_en"."personal name has value" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';
...
COMMENT ON VIEW "BW_en"."scalar measurement datum has measurement value" IS 'DataMinCardinality(1 <http://purl.obolibrary.org/obo/IAO_0000004> rdfs:Literal)';

CREATE VIEW "BW_en"."measurement unit label has value" AS
...
COMMENT ON VIEW "BW_en"."measurement unit label has value" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';

CREATE VIEW "BW_en"."centrally registered identifier symbol has value" AS
...
COMMENT ON VIEW "BW_en"."centrally registered identifier symbol has value" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';

CREATE VIEW "BW_en"."HBW_0000026 has measurement value" AS
  SELECT "HBW_0000026_uid" AS "uid HBW_0000026",  
    "HBW_0000026_IAO_0000004_decimal_IAO_0000004" AS "has measurement value"
  FROM "BW"."HBW_0000026_IAO_0000004_decimal";

COMMENT ON VIEW "BW_en"."HBW_0000026 has measurement value" IS 'DataMinCardinality(1 <http://purl.obolibrary.org/obo/IAO_0000004> xsd:decimal)';

CREATE VIEW "BW_en"."family name has value" AS
...
COMMENT ON VIEW "BW_en"."family name has value" IS 'DataExactCardinality(1 <http://purl.obolibrary.org/obo/PHYSIO_0000100> xsd:string)';
...
COMMENT ON VIEW "BW_en"."human name has_part personal name" IS 'An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
...
COMMENT ON VIEW "BW_en"."human name has_part family name" IS 'An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
a core relation that holds between a whole and its part
...
COMMENT ON VIEW "BW_en"."HBW_0000006_IAO_0000219_ONTORELA_C4d0c3f45" IS 'A CRID symbol that is sufficent to look up a patient file in a medical record registry. null medical record identifier intersectionOf A document that contains information representing health-relevant qualities of a patient written in a chronological manner and that is primarily used for patient care in a clinical setting. is_about is a (currently) primitive relation that relates an information artifact to an entity. An organism having the role of patient.';
...
COMMENT ON VIEW "BW_en"."ONTORELA_C4d0c3f45_IAO_0000136_HBW_0000007" IS 'medical record identifier intersectionOf A document that contains information representing health-relevant qualities of a patient written in a chronological manner and that is primarily used for patient care in a clinical setting. is_about is a (currently) primitive relation that relates an information artifact to an entity. An organism having the role of patient. is_about is a (currently) primitive relation that relates an information artifact to an entity. An organism having the role of patient.';

CREATE VIEW "BW_en"."independent continuant has role role" AS
  SELECT "BFO_0000004_uid" AS "uid independent continuant",  
    "BFO_0000023_uid" AS "uid role"
  FROM "BW"."BFO_0000004_RO_0000087_BFO_0000023";

COMMENT ON VIEW "BW_en"."independent continuant has role role" IS 'IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role';

CREATE VIEW "BW_en"."independent continuant located in independent continuant" AS
  SELECT "BFO_0000004_uid_domain" AS "uid independent continuant_domain",  
    "BFO_0000004_uid_range" AS "uid independent continuant_range"
  FROM "BW"."BFO_0000004_RO_0001025_BFO_0000004";

COMMENT ON VIEW "BW_en"."independent continuant located in independent continuant" IS 'IndependentContinuant a relation between two independent continuants, the target and the location, in which the target is entirely within the location IndependentContinuant';
...
COMMENT ON VIEW "BW_en"."HBW_0000005_BFO_0000051_HBW_0000006" IS 'A document that contains information representing the health-relevant qualities of a patient''s body, organ systems, individual organs, cells and biomolecules that perform chemical and physical functions. 
a core relation that holds between a whole and its part
...
COMMENT ON VIEW "BW_en"."HBW_0000005_BFO_0000051_HBW_0000001" IS 'A document that contains information representing the health-relevant qualities of a patient''s body, organ systems, individual organs, cells and biomolecules that perform chemical and physical functions. 
a core relation that holds between a whole and its part
 A data item that is the specified output of some physiological evaluation.';

CREATE VIEW "BW_en"."realizable entity realized in process" AS
  SELECT "BFO_0000017_uid" AS "uid realizable entity",  
    "BFO_0000015_uid" AS "uid process"
  FROM "BW"."BFO_0000017_BFO_0000054_BFO_0000015";

COMMENT ON VIEW "BW_en"."realizable entity realized in process" IS 'RealizableEntity Paraphrase of elucidation: a relation between a realizable entity and a process, where there is some material entity that is bearer of the realizable entity and participates in the process, and the realizable entity comes to be realized in the course of the process p is a process = Def. p is an occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t. (axiom label in BFO2 Reference: [083-003])';
...
COMMENT ON VIEW "BW_en"."entity part of entity" IS 'per discussion with Barry Smith a core relation that holds between a part and its whole per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_en"."information content entity denotes entity" IS 'An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity null per discussion with Barry Smith';

CREATE VIEW "BW_en"."birth statement is about Homo sapiens" AS
  SELECT "NOYO_0000050_uid" AS "uid birth statement",  
    "NCBITaxon_9606_uid" AS "uid Homo sapiens"
  FROM "BW"."NOYO_0000050_IAO_0000136_NCBITaxon_9606";

COMMENT ON VIEW "BW_en"."birth statement is about Homo sapiens" IS 'A statement about the information surrounding the birth of a human. is_about is a (currently) primitive relation that relates an information artifact to an entity. Organism member of the genus Homo, evolving from Homo heidelbergensis or a similar species and migrating out of Africa, gradually replacing or interbreeding with local populations of archaic humans.';
...
CREATE VIEW "BW_en"."process realizes realizable entity" AS
  SELECT "BFO_0000015_uid" AS "uid process",  
    "BFO_0000017_uid" AS "uid realizable entity"
  FROM "BW"."BFO_0000015_BFO_0000055_BFO_0000017";

COMMENT ON VIEW "BW_en"."process realizes realizable entity" IS 'p is a process = Def. p is an occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t. (axiom label in BFO2 Reference: [083-003]) Paraphrase of elucidation: a relation between a process and a realizable entity, where there is some material entity that is bearer of the realizable entity and participates in the process, and the realizable entity comes to be realized in the course of the process RealizableEntity';

CREATE VIEW "BW_en"."occurrent occurs in independent continuant" AS
  SELECT "BFO_0000003_uid" AS "uid occurrent",  
    "BFO_0000004_uid" AS "uid independent continuant"
  FROM "BW"."BFO_0000003_BFO_0000066_BFO_0000004";

COMMENT ON VIEW "BW_en"."occurrent occurs in independent continuant" IS '
An entity that has temporal parts and that happens, unfolds or develops through time.
 Paraphrase of definition: a relation between a process and an independent continuant, in which the process takes place entirely within the independent continuant IndependentContinuant';
