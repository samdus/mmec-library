...
COMMENT ON SCHEMA "BW_iri" IS 'Create views with short IRI of BW_iri 20240313-1437';
...
COMMENT ON VIEW "BW_iri"."BFO_0000020" IS 'specifically dependent continuant::b is a specifically dependent continuant = Def. b is a continuant & there is some independent continuant c which is not a spatial region and which is such that b s-depends_on c at every time t during the course of b’s existence. (axiom label in BFO2 Reference: [050-003])';
...
COMMENT ON VIEW "BW_iri"."VO_0000613" IS 'male biological sex datum::A biological sex datum that represents the biological sex of an animal (including human) as being male.';
...
COMMENT ON VIEW "BW_iri"."BFO_0000002" IS 'continuant::An entity that exists in full at any time in which it exists at all, persists through time while maintaining its identity and has no temporal parts.';
...
COMMENT ON VIEW "BW_iri"."HBW_0000022_BFO_0000051_IAO_0020015" IS 'human name has_part personal name::An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
...
COMMENT ON VIEW "BW_iri"."HBW_0000022_BFO_0000051_IAO_0020017" IS 'human name has_part family name::An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
a core relation that holds between a whole and its part
...
COMMENT ON VIEW "BW_iri"."HBW_0000006_IAO_0000219_ONTORELA_C4d0c3f45" IS 'medical record identifier denotes medical record identifier intersectionOf health care record | is about | patient::A CRID symbol that is sufficent to look up a patient file in a medical record registry. null medical record identifier intersectionOf A document that contains information representing health-relevant qualities of a patient written in a chronological manner and that is primarily used for patient care in a clinical setting. is_about is a (currently) primitive relation that relates an information artifact to an entity. An organism having the role of patient.';
...
COMMENT ON VIEW "BW_iri"."BFO_0000004_RO_0000087_BFO_0000023" IS 'independent continuant has role role::IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role';
...
COMMENT ON VIEW "BW_iri"."HBW_0000005_BFO_0000051_HBW_0000006" IS 'physiological evaluation report has_part medical record identifier::A document that contains information representing the health-relevant qualities of a patient''s body, organ systems, individual organs, cells and biomolecules that perform chemical and physical functions. 
a core relation that holds between a whole and its part
...
COMMENT ON VIEW "BW_iri"."HBW_0000005_BFO_0000051_HBW_0000001" IS 'physiological evaluation report has_part physiological data item::A document that contains information representing the health-relevant qualities of a patient''s body, organ systems, individual organs, cells and biomolecules that perform chemical and physical functions. 
a core relation that holds between a whole and its part
...
COMMENT ON VIEW "BW_iri"."BFO_0000001_BFO_0000050_BFO_0000001" IS 'entity part of entity::per discussion with Barry Smith a core relation that holds between a part and its whole per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_iri"."BFO_0000003_BFO_0000066_BFO_0000004" IS 'occurrent occurs in independent continuant::
An entity that has temporal parts and that happens, unfolds or develops through time.
