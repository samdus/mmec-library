...
COMMENT ON SCHEMA "BW_iri" IS 'Create views with short IRI of BW_iri 20240807-1140';
...
COMMENT ON VIEW "BW_iri"."BFO_0000040" IS 'material entity::MaterialEntity';
...
COMMENT ON VIEW "BW_iri"."BFO_0000017" IS 'realizable::A specifically dependent continuant that inheres in some independent continuant which is not a spatial region and is of a type instances of which are realized in processes of a correlated type.';
...
COMMENT ON VIEW "BW_iri"."IAO_0020015" IS 'personal name::Sep 29, 2016: The comment that including the wikipedia definition of personal name is not to be interpreted in a way that restricts this class to only contain strings of letters. A numerical or alphanumerical identifier that denotes a human is being is a personal name, too. (MB)';
...
COMMENT ON VIEW "BW_iri"."BFO_0000015" IS 'process::An occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t.';
...
COMMENT ON VIEW "BW_iri"."VO_0004895" IS 'female biological sex datum::A biological sex measurement datum that is intended to denote a female biological sex.';
...
COMMENT ON VIEW "BW_iri"."IAO_0000032_IAO_0000004_double" IS 'scalar measurement datum has measurement value Double::IAO_0000032 [1..1] IAO_0000004 double';
...
COMMENT ON VIEW "BW_iri"."IAO_0000032_IAO_0000004_Literal" IS 'scalar measurement datum has measurement value Literal::DataMinCardinality(1 <http://purl.obolibrary.org/obo/IAO_0000004> rdfs:Literal)';
...
COMMENT ON VIEW "BW_iri"."HBW_0000022_BFO_0000051_IAO_0020015" IS 'human name has_part personal name::An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. a core relation that holds between a whole and its part Sep 29, 2016: The comment that including the wikipedia definition of personal name is not to be interpreted in a way that restricts this class to only contain strings of letters. A numerical or alphanumerical identifier that denotes a human is being is a personal name, too. (MB)';
...
COMMENT ON VIEW "BW_iri"."BFO_0000001_BFO_0000050_BFO_0000001" IS 'entity part of entity::per discussion with Barry Smith 
...
COMMENT ON VIEW "BW_iri"."HBW_0000029_BFO_0000051_HBW_0000006" IS 'RAMQ vulnerability code statement has_part medical record identifier::A statement about the inscription of a patient in a category of health situation in order to adjust administrative handling of physician billing by the RAMQ. a core relation that holds between a whole and its part A CRID symbol that is sufficent to look up a patient file in a medical record registry.';
...
COMMENT ON VIEW "BW_iri"."HBW_0000029_BFO_0000051_HBW_0000002" IS 'RAMQ vulnerability code statement has_part RAMQ vulnerability code::A statement about the inscription of a patient in a category of health situation in order to adjust administrative handling of physician billing by the RAMQ. a core relation that holds between a whole and its part A data item categorizing a type of health situation in order to adjust administrative handling of physician billing by the RAMQ.';
...
COMMENT ON VIEW "BW_iri"."HBW_0000028_BFO_0000051_HBW_0000006" IS 'human biological sex or gender identity statement has_part medical record identifier::A statement about the biological sex or gender identity of a human a core relation that holds between a whole and its part A CRID symbol that is sufficent to look up a patient file in a medical record registry.';
...
COMMENT ON VIEW "BW_iri"."IAO_0000030_IAO_0000136_BFO_0000001" IS 'information content entity is about entity::A generically dependent continuant that is about some thing. is_about is a (currently) primitive relation that relates an information artifact to an entity. per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_iri"."IAO_0000030_IAO_0000219_BFO_0000001" IS 'information content entity denotes entity::A generically dependent continuant that is about some thing. null per discussion with Barry Smith';
