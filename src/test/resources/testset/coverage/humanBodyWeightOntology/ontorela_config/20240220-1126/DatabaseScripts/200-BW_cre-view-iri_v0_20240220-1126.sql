...
COMMENT ON SCHEMA "BW_iri" IS 'Create views with short IRI of BW_iri 20240220-1126';
...
COMMENT ON VIEW "BW_iri"."ONTORELA_C2986e108-el0" IS 'disposition or quality::(disposition or quality)
...
COMMENT ON VIEW "BW_iri"."BFO_0000031" IS 'gdc::GenericallyDependentContinuant';
...
COMMENT ON VIEW "BW_iri"."BFO_0000003" IS 'occurrent::per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_iri"."BFO_0000001_BFO_0000050_BFO_0000001" IS 'entity part of entity::Entity a core relation that holds between a part and its whole Entity';
...
COMMENT ON VIEW "BW_iri"."BFO_0000002_RO_0000056_BFO_0000003" IS 'continuant participates in occurrent::Continuant a relation between a continuant and a process, in which the continuant is somehow involved in the process per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_iri"."BFO_0000003_RO_0000057_BFO_0000002" IS 'occurrent has participant continuant::per discussion with Barry Smith a relation between a process and a continuant, in which the continuant is somehow involved in the process Continuant';
