...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240220-1126';
...
CREATE VIEW "BW_en"."disposition or quality" AS
  SELECT "ONTORELA_C2986e108-el0_uid" AS "uid disposition or quality"
...
COMMENT ON VIEW "BW_en"."gdc" IS 'GenericallyDependentContinuant';
...
COMMENT ON VIEW "BW_en"."quality" IS 'Quality';
...
COMMENT ON VIEW "BW_en"."occurrent" IS 'per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_en"."entity part of entity" IS 'Entity a core relation that holds between a part and its whole Entity';
...
COMMENT ON VIEW "BW_en"."continuant participates in occurrent" IS 'Continuant a relation between a continuant and a process, in which the continuant is somehow involved in the process per discussion with Barry Smith';
...
COMMENT ON VIEW "BW_en"."occurrent has participant continuant" IS 'per discussion with Barry Smith a relation between a process and a continuant, in which the continuant is somehow involved in the process Continuant';
