...
COMMENT ON SCHEMA "BW_iri" IS 'Create views with short IRI of BW_iri 20240501-1315';
...
COMMENT ON VIEW "BW_iri"."IAO_0020015" IS 'personal name::An identifier referring to an individual entity that is ascribed personhood by the user of the identifier.';
...
COMMENT ON VIEW "BW_iri"."BFO_0000019" IS 'quality::Quality';
...
COMMENT ON VIEW "BW_iri"."BFO_0000031" IS 'generically dependent continuant::GenericallyDependentContinuant';
...
COMMENT ON VIEW "BW_iri"."BFO_0000004" IS 'independent continuant::b is an independent continuant = Def. b is a continuant which is such that there is no c and no t such that b s-depends_on c at t. (axiom label in BFO2 Reference: [017-002])';
...
COMMENT ON VIEW "BW_iri"."BFO_0000004_RO_0000087_BFO_0000023" IS 'independent continuant has role role::b is an independent continuant = Def. b is a continuant which is such that there is no c and no t such that b s-depends_on c at t. (axiom label in BFO2 Reference: [017-002]) a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence Role';
...
COMMENT ON VIEW "BW_iri"."IAO_0000030_IAO_0000219_BFO_0000001" IS 'information content entity denotes entity::An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity null A thing that exists or has existed or will exist.';
