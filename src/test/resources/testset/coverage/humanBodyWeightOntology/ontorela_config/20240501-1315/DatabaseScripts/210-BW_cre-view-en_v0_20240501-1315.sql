...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240501-1315';
...
COMMENT ON VIEW "BW_en"."personal name" IS 'An identifier referring to an individual entity that is ascribed personhood by the user of the identifier.';
...
COMMENT ON VIEW "BW_en"."generically dependent continuant" IS 'GenericallyDependentContinuant';
...
COMMENT ON VIEW "BW_en"."independent continuant" IS 'b is an independent continuant = Def. b is a continuant which is such that there is no c and no t such that b s-depends_on c at t. (axiom label in BFO2 Reference: [017-002])';
...
COMMENT ON VIEW "BW_en"."entity part of entity" IS 'A thing that exists or has existed or will exist. 
...
COMMENT ON VIEW "BW_en"."information content entity is about entity" IS 'An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity is_about is a (currently) primitive relation that relates an information artifact to an entity. A thing that exists or has existed or will exist.';
...
COMMENT ON VIEW "BW_en"."information content entity denotes entity" IS 'An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity null A thing that exists or has existed or will exist.';
