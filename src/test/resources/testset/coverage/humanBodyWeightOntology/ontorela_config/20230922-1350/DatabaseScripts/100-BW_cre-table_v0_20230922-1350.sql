...
COMMENT ON SCHEMA "BW" IS 'Schéma BW créé le 20230922-1350';
...
COMMENT ON TABLE "BW"."T0007" IS 'process::Process';
...
COMMENT ON TABLE "BW"."T000a" IS 'realizable entity::A specifically dependent continuant that inheres in some independent continuant which is not a spatial region and is of a type instances of which are realized in processes of a correlated type.';
...
COMMENT ON TABLE "BW"."T000e" IS 'generically dependent continuant::b is a generically dependent continuant = Def. b is a continuant that g-depends_on one or more other entities. (axiom label in BFO2 Reference: [074-001])';

COMMENT ON COLUMN "BW"."T000e"."T000e_uid" IS 'uid generically dependent continuant::Default primary key of generically dependent continuant';
...
COMMENT ON TABLE "BW"."T0012" IS 'occurrent::
...
COMMENT ON TABLE "BW"."T0021" IS 'material entity::MaterialEntity';
...
COMMENT ON TABLE "BW"."T0022" IS 'information content entity::A generically dependent continuant that is about some thing.';
...
COMMENT ON COLUMN "BW"."T002b"."T000b_uid" IS 'uid medical record identifier::Default primary key of medical record identifier';
...
(
  "T0006_uid" "BW"."uid_domain"  NOT NULL, 
  "T001f_uid" "BW"."uid_domain"  NOT NULL,
  CONSTRAINT key_T002c PRIMARY KEY ("T0006_uid", "T001f_uid")
);
...
COMMENT ON COLUMN "BW"."T002c"."T001f_uid" IS 'uid physiological data item::Default primary key of physiological data item';
...
COMMENT ON TABLE "BW"."T0034" IS 'entity part of entity::Entity a core relation that holds between a part and its whole Entity';
...
COMMENT ON TABLE "BW"."T0035" IS 'occurrent occurs in independent continuant::
An entity that has temporal parts and that happens, unfolds or develops through time.
...
COMMENT ON TABLE "BW"."T0036" IS 'occurrent has participant continuant::
An entity that has temporal parts and that happens, unfolds or develops through time.
...
COMMENT ON TABLE "BW"."T0040" IS 'information content entity is about entity::A generically dependent continuant that is about some thing. is_about is a (currently) primitive relation that relates an information artifact to an entity. Entity';
...
COMMENT ON TABLE "BW"."T0041" IS 'information content entity denotes entity::A generically dependent continuant that is about some thing. null Entity';
...
(
  "T0024_uid" "BW"."uid_domain"  NOT NULL, 
  "T000d_uid" "BW"."uid_domain"  NOT NULL,
  CONSTRAINT key_T0043 PRIMARY KEY ("T0024_uid", "T000d_uid")
);

COMMENT ON TABLE "BW"."T0043" IS 'scalar measurement datum has value specification scalar value specification::a scalar measurement datum is a measurement datum that is composed of two parts, numerals and a unit label. null A value specification that consists of two parts: a numeral and a unit label';

COMMENT ON COLUMN "BW"."T0043"."T0024_uid" IS 'uid scalar measurement datum::Default primary key of scalar measurement datum';

COMMENT ON COLUMN "BW"."T0043"."T000d_uid" IS 'uid scalar value specification::Default primary key of scalar value specification';
...
(
  "T0024_uid" "BW"."uid_domain"  NOT NULL, 
  "T0000_uid" "BW"."uid_domain"  NOT NULL,
  CONSTRAINT key_T0044 PRIMARY KEY ("T0024_uid")
);

COMMENT ON TABLE "BW"."T0044" IS 'scalar measurement datum has measurement unit label Thing::a scalar measurement datum is a measurement datum that is composed of two parts, numerals and a unit label. null The class owl:Thing is the class of all individuals.';

COMMENT ON COLUMN "BW"."T0044"."T0024_uid" IS 'uid scalar measurement datum::Default primary key of scalar measurement datum';

COMMENT ON COLUMN "BW"."T0044"."T0000_uid" IS 'uid Thing::Default primary key of Thing';
...
COMMENT ON TABLE "BW"."T0045" IS 'continuant participates in occurrent::Continuant a relation between a continuant and a process, in which the continuant is somehow involved in the process 
An entity that has temporal parts and that happens, unfolds or develops through time.
';
...
COMMENT ON CONSTRAINT fk0_T000e ON "BW"."T000e" IS 'generically dependent continuant -> continuant';
...
COMMENT ON CONSTRAINT fk0_T0022 ON "BW"."T0022" IS 'information content entity -> generically dependent continuant';
...
COMMENT ON CONSTRAINT fk0_T002b ON "BW"."T002b" IS 'physiological evaluation report has_part medical record identifier -> physiological evaluation report';

-- Foreign key definition : T002b -> T000b
ALTER TABLE "BW"."T002b"
  ADD CONSTRAINT fk1_T002b FOREIGN KEY ("T000b_uid")
    REFERENCES "BW"."T000b" ("T000b_uid");

COMMENT ON CONSTRAINT fk1_T002b ON "BW"."T002b" IS 'physiological evaluation report has_part medical record identifier -> medical record identifier';
...
COMMENT ON CONSTRAINT fk0_T002c ON "BW"."T002c" IS 'physiological evaluation report has_part physiological data item -> physiological evaluation report';

-- Foreign key definition : T002c -> T001f
ALTER TABLE "BW"."T002c"
  ADD CONSTRAINT fk1_T002c FOREIGN KEY ("T001f_uid")
    REFERENCES "BW"."T001f" ("T001f_uid");

COMMENT ON CONSTRAINT fk1_T002c ON "BW"."T002c" IS 'physiological evaluation report has_part physiological data item -> physiological data item';
...
COMMENT ON CONSTRAINT fk0_T0033 ON "BW"."T0033" IS 'generically dependent continuant is concretized as sdc -> generically dependent continuant';
...
COMMENT ON CONSTRAINT fk1_T0033 ON "BW"."T0033" IS 'generically dependent continuant is concretized as sdc -> sdc';
...
COMMENT ON CONSTRAINT fk0_T0042 ON "BW"."T0042" IS 'sdc concretizes generically dependent continuant -> sdc';
...
COMMENT ON CONSTRAINT fk1_T0042 ON "BW"."T0042" IS 'sdc concretizes generically dependent continuant -> generically dependent continuant';
...
COMMENT ON CONSTRAINT fk0_T0043 ON "BW"."T0043" IS 'scalar measurement datum has value specification scalar value specification -> scalar measurement datum';

-- Foreign key definition : T0043 -> T000d
ALTER TABLE "BW"."T0043"
  ADD CONSTRAINT fk1_T0043 FOREIGN KEY ("T000d_uid")
    REFERENCES "BW"."T000d" ("T000d_uid");

COMMENT ON CONSTRAINT fk1_T0043 ON "BW"."T0043" IS 'scalar measurement datum has value specification scalar value specification -> scalar value specification';
...
COMMENT ON CONSTRAINT fk0_T0044 ON "BW"."T0044" IS 'scalar measurement datum has measurement unit label Thing -> scalar measurement datum';

-- Foreign key definition : T0044 -> T0000
ALTER TABLE "BW"."T0044"
  ADD CONSTRAINT fk1_T0044 FOREIGN KEY ("T0000_uid")
    REFERENCES "BW"."T0000" ("T0000_uid");

COMMENT ON CONSTRAINT fk1_T0044 ON "BW"."T0044" IS 'scalar measurement datum has measurement unit label Thing -> Thing';
