...
COMMENT ON SCHEMA "BW_ontoView" IS 'Create views with short IRI of BW_ontoView 20230922-1350';
...
CREATE VIEW "BW_ontoView"."PHYSIO_0000083_p" AS
  SELECT *
  FROM "BW"."T0006" 
    JOIN "BW"."T002b" USING("T0006_uid") -- PHYSIO_0000083 [1..1] BFO_0000051 HADO_0000006
;
...
CREATE VIEW "BW_ontoView"."PHYSIO_0000083_c" AS
  SELECT *
  FROM "BW"."T0006" 
    JOIN "BW"."T002c" USING("T0006_uid") -- PHYSIO_0000083 [1..*] BFO_0000051 PHYSIO_0000093
    JOIN "BW"."T002b" USING("T0006_uid") -- PHYSIO_0000083 [1..1] BFO_0000051 HADO_0000006
;
...
COMMENT ON VIEW "BW_ontoView"."BFO_0000004_c" IS 'independent continuant::IndependentContinuant IndependentContinuant a relation between two independent continuants, the target and the location, in which the target is entirely within the location IndependentContinuant IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence A realizable entity that exists because there is some single bearer that is in some particular physical, social, or institutional set of circumstances in which this bearer does not have to be and is not such that, if it ceases to exist, then the physical make-up of the bearer is thereby changed.';
