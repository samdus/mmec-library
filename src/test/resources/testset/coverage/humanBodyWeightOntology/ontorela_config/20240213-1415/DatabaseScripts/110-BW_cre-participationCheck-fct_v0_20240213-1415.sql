...
-- Minimum participation ckeck on : ONTORELA_C2986e108-el0_RO_0000052_OBI_0100026
CREATE OR REPLACE FUNCTION "BW"."ONTORELA_C2986e108-el0_RO_0000052_OBI_0100026_checkParticipationMin"("_ONTORELA_C2986e108-el0_uid" "BW"."uid_domain")
  RETURNS BOOLEAN AS
$$
BEGIN
  IF
  (
    (
      ...
      WHERE "ONTORELA_C2986e108-el0_uid" = "_ONTORELA_C2986e108-el0_uid"
    ) >= 1
  )
  THEN
    RETURN TRUE;
  ELSE
    RAISE NOTICE 'Participation  %  does not respect minimum value %', 'ONTORELA_C2986e108-el0_RO_0000052_OBI_0100026', 1;
    RETURN FALSE;
  END IF;
END;
$$
