...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240213-1415';
...
COMMENT ON VIEW "BW_en"."specifically dependent continuant" IS 'SpecificallyDependentContinuant';

CREATE VIEW "BW_en"."material entity" AS
  SELECT "BFO_0000040_uid" AS "uid material entity"
  FROM "BW"."BFO_0000040";

COMMENT ON VIEW "BW_en"."material entity" IS 'An independent continuant that is spatially extended whose identity is independent of that of other entities and can be maintained through time.';
...
COMMENT ON VIEW "BW_en"."realizable entity" IS 'A specifically dependent continuant that inheres in some independent continuant which is not a spatial region and is of a type instances of which are realized in processes of a correlated type.';

CREATE VIEW "BW_en"."entity" AS
  SELECT "BFO_0000001_uid" AS "uid entity"
  FROM "BW"."BFO_0000001";

COMMENT ON VIEW "BW_en"."entity" IS 'Entity';
...
COMMENT ON VIEW "BW_en"."male biological sex datum" IS 'A biological sex measurement datum that is intended to denote a male biological sex.';
...
COMMENT ON VIEW "BW_en"."continuant" IS '
...
COMMENT ON VIEW "BW_en"."independent continuant has role role" IS 'IndependentContinuant a relation between an independent continuant (the bearer) and a role, in which the role specifically depends on the bearer for its existence A realizable entity that exists because there is some single bearer that is in some particular physical, social, or institutional set of circumstances in which this bearer does not have to be and is not such that, if it ceases to exist, then the physical make-up of the bearer is thereby changed.';
...
COMMENT ON VIEW "BW_en"."entity part of entity" IS 'Entity 
...
COMMENT ON VIEW "BW_en"."identifier denotes entity" IS 'An information content entity that is the outcome of a dubbing process and is used to refer to one instance of entity shared by a group of people to refer to that individual entity. null Entity';
...
COMMENT ON VIEW "BW_en"."continuant participates in occurrent" IS '
An entity that exists in full at any time in which it exists at all, persists through time while maintaining its identity and has no temporal parts.
 a relation between a continuant and a process, in which the continuant is somehow involved in the process Occurrent';
...
COMMENT ON VIEW "BW_en"."information content entity denotes entity" IS 'An information content entity is an entity that is generically dependent on some artifact and stands in relation of aboutness to some entity null Entity';
...
COMMENT ON VIEW "BW_en"."occurrent has participant continuant" IS 'Occurrent a relation between a process and a continuant, in which the continuant is somehow involved in the process 
An entity that exists in full at any time in which it exists at all, persists through time while maintaining its identity and has no temporal parts.
';
