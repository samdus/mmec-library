...
COMMENT ON SCHEMA "BW_iri" IS 'Create views with short IRI of BW_iri 20240213-1415';
...
COMMENT ON VIEW "BW_iri"."BFO_0000015" IS 'process::Process';
...
COMMENT ON VIEW "BW_iri"."IAO_0020000_IAO_0000219_BFO_0000001" IS 'identifier denotes entity::An information content entity that is the outcome of a dubbing process and is used to refer to one instance of entity shared by a group of people to refer to that individual entity. null Entity';
...
COMMENT ON VIEW "BW_iri"."BFO_0000002_RO_0000056_BFO_0000003" IS 'continuant participates in occurrent::
An entity that exists in full at any time in which it exists at all, persists through time while maintaining its identity and has no temporal parts.
...
COMMENT ON VIEW "BW_iri"."BFO_0000003_RO_0000057_BFO_0000002" IS 'occurrent has participant continuant::Occurrent a relation between a process and a continuant, in which the continuant is somehow involved in the process 
An entity that exists in full at any time in which it exists at all, persists through time while maintaining its identity and has no temporal parts.
';
