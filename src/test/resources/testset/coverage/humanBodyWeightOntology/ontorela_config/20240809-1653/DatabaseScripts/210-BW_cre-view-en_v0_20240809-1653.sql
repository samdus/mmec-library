...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240809-1653';
...
COMMENT ON VIEW "BW_en"."process" IS '
...
COMMENT ON VIEW "BW_en"."ic" IS 'b is an independent continuant = Def. b is a continuant which is such that there is no c and no t such that b s-depends_on c at t. (axiom label in BFO2 Reference: [017-002])';
...
COMMENT ON VIEW "BW_en"."process realizes realizable entity" IS '
An occurrent that has temporal proper parts and for some time t, p s-depends_on some material entity at t.
...
An entity that has temporal parts and that happens, unfolds or develops through time.
 Paraphrase of definition: a relation between a process and an independent continuant, in which the process takes place entirely within the independent continuant b is an independent continuant = Def. b is a continuant which is such that there is no c and no t such that b s-depends_on c at t. (axiom label in BFO2 Reference: [017-002])';
...
COMMENT ON VIEW "BW_en"."HBW_0000029_BFO_0000051_HBW_0000006" IS 'A statement about the inscription of a patient in a category of health situation in order to adjust administrative handling of physician billing by the RAMQ. 
a core relation that holds between a whole and its part
 A CRID symbol that is sufficent to look up a patient file in a medical record registry.';
...
a core relation that holds between a whole and its part
 A data item categorizing a type of health situation in order to adjust administrative handling of physician billing by the RAMQ.';
...
COMMENT ON VIEW "BW_en"."HBW_0000028_BFO_0000051_HBW_0000006" IS 'A statement about the biological sex or gender identity of a human 
a core relation that holds between a whole and its part
 A CRID symbol that is sufficent to look up a patient file in a medical record registry.';
...
COMMENT ON VIEW "BW_en"."HBW_0000028_BFO_0000051_IOIO_0000012" IS 'A statement about the biological sex or gender identity of a human 
a core relation that holds between a whole and its part
 An information content entity that denotes a biological sex or a gender identity of a human.';
