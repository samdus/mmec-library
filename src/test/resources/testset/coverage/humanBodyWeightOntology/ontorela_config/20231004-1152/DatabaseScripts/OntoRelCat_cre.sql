...
------------------------------------------------------------------------------
Produit : OntoRela
Résumé : Ce script contient une séquence de requêtes SQL nécessaires pour la création du dictionnaire de données OntoRelCat.
Projet : REQ-ONTO
...
-- Création du table Ontorel_Import
