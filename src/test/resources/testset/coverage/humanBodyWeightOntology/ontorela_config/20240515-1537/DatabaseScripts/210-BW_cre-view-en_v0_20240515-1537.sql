...
COMMENT ON SCHEMA "BW_en" IS 'Create views in en of BW 20240515-1537';
...
COMMENT ON VIEW "BW_en"."sdc" IS 'SpecificallyDependentContinuant';
...
COMMENT ON VIEW "BW_en"."entity" IS 'A thing that exists or has existed or will exist.';
...
COMMENT ON VIEW "BW_en"."continuant" IS 'Continuant';
...
CREATE VIEW "BW_en"."gdc" AS
  SELECT "BFO_0000031_uid" AS "uid gdc"
  FROM "BW"."BFO_0000031";

COMMENT ON VIEW "BW_en"."gdc" IS 'A continuant that is dependent on one or other independent continuant bearers. For every instance of A requires some instance of (an independent continuant type) B but which instance of B serves can change from time to time.';
...
COMMENT ON VIEW "BW_en"."human name has part family name" IS 'An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
...
COMMENT ON VIEW "BW_en"."human name has part personal name" IS 'An identifier that is composed of some family name and some personal name that denotes of an Homo Sapiens. 
a core relation that holds between a whole and its part
...
COMMENT ON VIEW "BW_en"."entity part of entity" IS 'A thing that exists or has existed or will exist. a core relation that holds between a part and its whole A thing that exists or has existed or will exist.';
...
COMMENT ON VIEW "BW_en"."identifier denotes entity" IS 'An information content entity that is the outcome of a dubbing process and is used to refer to one instance of entity shared by a group of people to refer to that individual entity. null A thing that exists or has existed or will exist.';
...
COMMENT ON VIEW "BW_en"."information content entity is about entity" IS 'A generically dependent continuant that is about some thing. is_about is a (currently) primitive relation that relates an information artifact to an entity. A thing that exists or has existed or will exist.';
...
COMMENT ON VIEW "BW_en"."information content entity denotes entity" IS 'A generically dependent continuant that is about some thing. null A thing that exists or has existed or will exist.';
...
COMMENT ON VIEW "BW_en"."continuant participates in occurrent" IS 'Continuant a relation between a continuant and a process, in which the continuant is somehow involved in the process Occurrent';
