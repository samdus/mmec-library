...
| Arrimage d'un OP qui sous-type un OP du parent
| Non
| X |
| 'physiological evaluation' 'has evaluant' max 1 'Homo sapiens' ; 'physiological evaluation from health care provider' 'has evaluant' max 1 'health care provider';
